...
using TDStore.Identity.Contracts.DTOs;
...
namespace TDStore.Identity.Controllers
{
    ...
    public class AuthenticationController : MainController
    {
        ...
        public async Task<ActionResult> Login(UserLoginDTO userLogin)
        {
            ...
            {
                AddErrorProcessing("Usuario Temporariamente bloqueado por tentativas invalidas");
                return CustomResponse();
            }

            AddErrorProcessing("Usuário ou senha inválidos");

            return CustomResponse();
        }

        [HttpPost("cadastrar")]
        public async Task<ActionResult> Registrar(UserDTO userRegister)
        {
            if (!ModelState.IsValid) return CustomResponse(ModelState);
        ...
        // EpochDate = segundos relativo a data informada
